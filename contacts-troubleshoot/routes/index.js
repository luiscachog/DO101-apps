        ...
        pgconn.query(
          ...
          function (err, results) {
            if (err) {
              console.log(err);
              res.render("index", {
                error: "Database initialization failure! " + err.stack,
                contacts: null,
                title: "Contact List",
              });
            } else {
              pgconn.query(
                "insert into contacts(firstname, lastname, email) values ('Bilbo','Baggins','bilbo@theshire.com'),('Frodo','Baggins','frodo@theshire.com'),('Samwise','Gamgee','sam@theshire.com'),('Peregrin','Took','pippin@theshire.com'),('Meriadoc','Brandybuck','merry@theshire.com')",
                function (err, results) {
                  if (err) {
                    console.log(err);
                    res.render("index", {
